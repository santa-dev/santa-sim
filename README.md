...
For more information on how to download, build and use the software please consult [the documentation page](https://github.com/santa-dev/santa-sim/wiki/Documentation) of the wiki page.
